...
/***/ 25:
/*!**********************************************************************************!*\
  !*** D:/微信程序开发工具/项目/app-ui 小U商城 小程序/小U商城/main.js?{"page":"pages%2Fcart%2Fcart"} ***!
  \**********************************************************************************/
...
/***/ 26:
/*!***************************************************************!*\
  !*** D:/微信程序开发工具/项目/app-ui 小U商城 小程序/小U商城/pages/cart/cart.vue ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ 27:
/*!**********************************************************************************************!*\
  !*** D:/微信程序开发工具/项目/app-ui 小U商城 小程序/小U商城/pages/cart/cart.vue?vue&type=template&id=0f00adf4& ***!
  \**********************************************************************************************/
...
/***/ 28:
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/微信程序开发工具/项目/app-ui 小U商城 小程序/小U商城/pages/cart/cart.vue?vue&type=template&id=0f00adf4& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 29:
/*!****************************************************************************************!*\
  !*** D:/微信程序开发工具/项目/app-ui 小U商城 小程序/小U商城/pages/cart/cart.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 30:
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/微信程序开发工具/项目/app-ui 小U商城 小程序/小U商城/pages/cart/cart.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...

{
  ...
  methods: {
    //封装，增加，减少
    comment: function comment(index, number) {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _this$list$index, id, num, checked, data, token, result;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                //页面增加/  减少
                if (number) {
                  _this.list[index].num = _this.list[index].num + number;
                }
                //调用接口更新数据
                _this$list$index =
                ...
                _this.list[index], id = _this$list$index.id, num = _this$list$index.num, checked = _this$list$index.checked;
                ...
                token = {
                  authorization: uni.getStorageSync('userInfo').token };_context.next = 7;return (

                  (0, _api.cartedit)(data, token));case 7:result = _context.sent;case 8:case "end":return _context.stop();}}}, _callee);}))();

    },
    add: function add(index) {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                _this2.comment(index, 1); //点击增加
    ...
    switchCheck: function switchCheck(e, index) {//点击单选
    ...
    //点击全选
    doAllCheck: function doAllCheck() {
    ...
    toConfirm: function toConfirm() {
      ...
      //当都是不选的时候 ，不让去结算跳转
      var a = this.list.some(function (item) {
    ...
    remove: function remove(index) {var _this3 = this;
      console.log('删除');
      // console.log(this.list[index].id)
      //确定要删除吗
      uni.showModal({
        title: '你确定要删除吗',
        success: function () {var _success = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3(res) {var data, token, result;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:if (!
                    res.confirm) {_context3.next = 15;break;}
                    console.log('用户点击确定');

                    data = {
                      id: _this3.list[index].id };

                    token = {
                      authorization: uni.getStorageSync('userInfo').token };_context3.next = 6;return (

                      (0, _api.cartdelete)(data, token));case 6:result = _context3.sent;

                    data = {
                      uid: uni.getStorageSync('userInfo').uid };

                    token = {
                      authorization: uni.getStorageSync('userInfo').token };_context3.next = 11;return (

                      (0, _api.cartlist)(data, token));case 11:result = _context3.sent;
                    // console.log(result[1].data.list) 
                    if (result[1].data.list) {
                      result[1].data.list.forEach(function (item) {
                        item.checked = item.checked == 1 ? true : false;
                        item.img = _tools.baseUrl + item.img;
                      });
                      _this3.list = result[1].data.list;
                    } else {
                      _this3.list = result[1].data.list;
                    ...
                    if (res.cancel) {
                      console.log('用户点击取消');
                    }case 16:case "end":return _context3.stop();}}}, _callee3);}));function success(_x) {return _success.apply(this, arguments);}return success;}() });



    },
    //公共读取 购物车列表
    readShopCart: function readShopCart() {var _this4 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {var data, token, result;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
                data = {
                  uid: uni.getStorageSync('userInfo').uid };

                token = {
                  authorization: uni.getStorageSync('userInfo').token };_context4.next = 4;return (

                  (0, _api.cartlist)(data, token));case 4:result = _context4.sent;
                // console.log(result[1].data.list)
                if (result[1].data.list) {
                  result[1].data.list.forEach(function (item) {
                    item.checked = item.checked == 1 ? true : false;
                  ...
                  _this4.list = result[1].data.list;
                } else {
                  _this4.list = result[1].data.list;
  ...
  onLoad: function onLoad(e) {var _this5 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee5() {return _regenerator.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
              // console. log(e)
              _this5.readShopCart();case 1:case "end":return _context5.stop();}}}, _callee5);}))();

  },
  onShow: function onShow() {var _this6 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee6() {return _regenerator.default.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:
              _this6.readShopCart();case 1:case "end":return _context6.stop();}}}, _callee6);}))();
  },
  ...
  computed: {
    ...
    // 全选 ，全不选
    isAllCheck: {
      get: function get() {//其他项（单个复选框）改变，影响  全选项
...
/***/ 31:
/*!************************************************************************************************!*\
  !*** D:/微信程序开发工具/项目/app-ui 小U商城 小程序/小U商城/pages/cart/cart.vue?vue&type=style&index=0&lang=css& ***!
  \************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 32:
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/微信程序开发工具/项目/app-ui 小U商城 小程序/小U商城/pages/cart/cart.vue?vue&type=style&index=0&lang=css& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
